...
# t-test 1 - Is the PSI across all lots, i.e. in total, statistically different from the population mean of 1,500 pounds per square inch?
...
#use the one sample t-tesy since we are testing against a presumed population mean
...
#t-test 2 Is the Lot 3 PSI statistically different from the presumed population mean of 1500 psi?
#use the one sample t-tesy since we are testing against a presumed population mean
